...
void Core::Initialize( )
{
	...
	SDL_Surface* pIcon = IMG_Load("Resources/favicon.png");
	if (pIcon == nullptr)
	{
		std::cerr << "Core::Initialize( ), error when calling IMG_Load: " << SDL_GetError() << std::endl;
		std::cerr << "Using default icon." << std::endl;
	}
